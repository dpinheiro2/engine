...
@Entity
@Table(name="truco_retain_active")
public class TrucoRetainActive extends GenericTruco implements CaseComponent, Serializable {
    ...
    @Column(name = "stateDecisionToken", nullable = true)
    ...
    @Column(name = "triedTrucoBluffs", nullable = true)
    private Integer triedTrucoBluffs;

    @Column(name = "trucoBluffCanBeDetected", nullable = true)
    private Integer trucoBluffCanBeDetected;

    @Column(name = "trucoBluffSuccessful", nullable = true)
    private Integer trucoBluffSuccessful;
    ...
    public Integer getTriedTrucoBluffs() {
        return triedTrucoBluffs;
    }

    public void setTriedTrucoBluffs(Integer triedTrucoBluffs) {
        this.triedTrucoBluffs = triedTrucoBluffs;
    }

    public Integer getTrucoBluffCanBeDetected() {
        return trucoBluffCanBeDetected;
    }

    public void setTrucoBluffCanBeDetected(Integer trucoBluffCanBeDetected) {
        this.trucoBluffCanBeDetected = trucoBluffCanBeDetected;
    }

    public Integer getTrucoBluffSuccessful() {
        return trucoBluffSuccessful;
    }

    public void setTrucoBluffSuccessful(Integer trucoBluffSuccessful) {
    ...
    public String toString() {
        return "Truco{" +
                ...
                ", triedTrucoBluffs=" + triedTrucoBluffs +
                ", trucoBluffCanBeDetected=" + trucoBluffCanBeDetected +
                ", trucoBluffSuccessful=" + trucoBluffSuccessful +
                ", jogada='" + jogada + '\'' +
                ", isBluff=" + isBluff +
                ", typeBluff='" + typeBluff + '\'' +
